...
namespace Project_Pilot_FreeJob.Controllers
{
    public class ServicosController : Controller
    {
        ...
        public ServicosController(FreeJobDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ServicoId,Descricao")] Servico servico)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ServicoId,Descricao")] Servico servico)
        {
